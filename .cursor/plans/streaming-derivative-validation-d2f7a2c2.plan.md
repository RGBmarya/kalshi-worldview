<!-- d2f7a2c2-c0e2-444b-b05f-b89f65f95c15 85ce5a5a-3526-44c7-ad9a-b1698b052871 -->
...
2. Generate 20-40 derivative beliefs (existing)
...
- [ ] Create ValidationClient in server/app/validation.py with LLM-as-judge for scoring derivative beliefs
- [ ] Create ExaClient in server/app/exa_client.py for bull/bear evidence search
- [ ] Add DerivativeBelief, StreamEvent, SearchRequest/Response models to server/app/models.py
- [ ] Update /graph endpoint to support SSE streaming with stream query parameter
- [ ] Integrate ValidationClient into /graph endpoint with threshold filtering and streaming events
- [ ] Add /search POST endpoint for EXA-powered bull/bear analysis
- [ ] Update README with new env vars (EXA_API_KEY, VALIDATION_THRESHOLD) and endpoints